...
import static com.ksoot.spark.iceberg.util.Constants.BACKTICK;
...
public class SparkUtils {
  ...
  public static Timestamp toSparkTimestamp(final LocalDateTime localDateTime) {
    return Timestamp.valueOf(localDateTime);
  }

  public static Timestamp currentSparkTimestamp() {
